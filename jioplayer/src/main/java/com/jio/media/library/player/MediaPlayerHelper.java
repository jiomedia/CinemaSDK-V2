        ...
        AdsMediaSource.MediaSourceFactory, AdEvent.AdEventListener
{
    ...
    public void setUiControllersVisibility(boolean visibility)
    {
...
//        }
    ...
    public static class Builder
    {
        ...
        {
            mExoPlayerHelper = new MediaPlayerHelper(context, exoPlayerView);
        }
        ...
        public Builder setExoPlayerEventsListener(MediaPlayerListener exoPlayerListener)
        {
            mExoPlayerHelper.setExoPlayerEventsListener(exoPlayerListener);
            return this;
        }

        public Builder setExoAdEventsListener(MediaAdsListener exoAdListener)
        {
     ...
     */
    @Override
    public void setExoThumbListener(MediaThumbListener exoThumbListener)
    {
    ...
    @Override
    public void setExoPlayerEventsListener(MediaPlayerListener pExoPlayerListenerListener)
    {
    ...
    public void createPlayer(boolean isToPrepare)
    {
        ...
        mPlayer = ExoPlayerFactory.newSimpleInstance(mContext, new DefaultRenderersFactory(mContext), new DefaultTrackSelector(), mLoadControl);
